...
def main(model_type):
    ...
    # 1. Load Data
    train_df, val_df, test_df = load_fake_news_dataset(save_dir="../data")
    ...
    if model_type == 'svm':
        ...
        X_train, X_val, X_test, vectorizer = preprocess_and_vectorize(
            train_texts, val_texts, test_texts, save_dir="../models"
        )
        
        # 3. Train
        model = train_svm(X_train, train_labels, save_dir="../models")
